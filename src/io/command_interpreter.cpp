...
// mmproject.dicmdCreateObjLine -brush 1 -color #000000 -fill 9 -points
// {(128,219);(328,100)} mmproject.dicmdQaToolExit dicmdSelectShapesByRegion
// -end (471,236) -start (112,24) mmproject.dicmdQaCompareSelection()
static PyMethodDef MMProjectMethods[] = {
    {"dicmdCanvasMouseClick", python_dicmdCanvasMouseClick, METH_VARARGS,
     "Mouse click action on canvas."},
    {"dicmdCanvasMousePress", python_dicmdCanvasMousePress, METH_VARARGS,
     "Mouse press (and hold) action on canvas."},
    {"dicmdCanvasMouseRelease", python_dicmdCanvasMouseRelease, METH_VARARGS,
     "Mouse release action on canvas."},
    {"dicmdCreateObjLine", python_dicmdCreateObjLine, METH_VARARGS,
     "Creates line on canvas given coordinates."},
    {"dicmdCreateObjRectangle", python_dicmdCreateObjRectangle, METH_VARARGS,
     "Creates rectangle on canvas given coordinates."},
    {"dicmdSelectShapesByRegion", python_dicmdSelectShapesByRegion,
     METH_VARARGS, "Selects shapes in canvas given coordinates."},
    {"dicmdQaCompareSelection", python_dicmdQaCompareSelection, METH_VARARGS,
     "Selects shapes in canvas given coordinates."},
    {"dicmdQaToolExit", python_dicmdQaToolExit, METH_VARARGS, "Exit the tool."},
    {NULL, NULL, 0, NULL}};

static PyModuleDef MMProjectModule = {PyModuleDef_HEAD_INIT,
                                      "emb",
                                      NULL,
                                      -1,
                                      MMProjectMethods,
...
static PyObject *PyInit_mmproject(void) {
