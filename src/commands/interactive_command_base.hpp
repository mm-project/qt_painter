...
class InteractiveCommandBase : public CommandBase {
  ...
  public:
    virtual CommandType get_type() { return Interactive; }
    ...
    virtual bool need_log_mouserelease() { return false; }

  public:
    void set_auto_repeat(bool m) { m_autorepeat = m; }

    bool is_auto_repeating() { return m_autorepeat; }

    void set_next_handler(CmdMemFun fun) { m_current_event_handler = fun; }

    QPoint get_last_point() { return m_last_cursor_point; }

    QPoint get_lastclk_point() { return m_last_click_point; }
