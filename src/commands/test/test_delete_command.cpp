...
// std::vector<IShapePtr> res; return res; } IShapePtr
// ObjectPoolBase::addObject(IShapePtr s) { return s;} std::string
// Design::getName() const noexcept {} std::string ObjectPoolBase::getName()
// const noexcept {}
...
/*!
    \brief UT_delete_command is entry point for unit testing delete_command
   module .
