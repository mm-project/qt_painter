...
enum LeCallbackType {DB_SHAPE_ADDED, DB_SHAPE_WILLBE_DELETED, CONTROLLER_CHANGED, CANVAS_VIEWPORT_CHANGED, MESSENGER,INTERACTIVE_COMMAND_PRE_COMMIT,INTERACTIVE_COMMAND_POST_COMMIT};
