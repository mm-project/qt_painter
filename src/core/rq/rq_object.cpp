...
IShapePtr RQrect::getObject() const { return m_object; }
...
IShapePtr RQellipse::getObject() const { return m_object; }
...
IShapePtr RQpolygon::getObject() const { return m_object; }
