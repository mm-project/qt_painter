...
void performance_test1() {
    ...
    // 5120, 10240}; std::vector<int> magnitudes = {10, 20, 40, 80, 160, 320,
    // 640, 1280, 2560, 5120}; std::vector<int> magnitudes = {10, 20, 40, 80,
    // 160, 320, 640, 1280}; std::vector<int> magnitudes = {50, 150, 200, 250};
