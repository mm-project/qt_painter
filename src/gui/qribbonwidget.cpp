...
QRibbonWidget::QRibbonWidget(QWidget *p) : QWidget(p) {
...
QRibbonWidget::~QRibbonWidget() { m_groups.clear(); }
...
void QRibbonWidget::addStretch(int i) { m_groupLayout->addStretch(i); }
